...
class RC:
    ...
    def __init__(self):
        ...
        #self.change = True
        self.joystick = Double_Joystick(conf.X_PIN,conf.Y_PIN,28,conf.B_PIN,1) # Pins for x axis, y axis and button
        self.timer = Timer()
    ...
    def send(self,t): 
        ...
        data = encode_motor(self.speed, self.turn_val, self.forward, self.get_button_pressed(), self.z)
